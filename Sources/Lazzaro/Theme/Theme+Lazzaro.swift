...
//  Theme+Lazzaro
//
//  Created by chuynadamas on 8/28/21.
//
import Plot
import Foundation
import Publish
...
extension Theme where Site == Lazzaro {
    ...
    static var lazzaro: Self {
        Theme(
            ...
            resourcePaths: ["Resources/style/styles.css",
...
private struct LazzaroHTMLFactory<Lazzaro: Website>: HTMLFactory {
    ...
    func makeSectionHTML(for section: Section<Lazzaro>,
                         context: PublishingContext<Lazzaro>) throws -> HTML {
        HTML(
            .lang(context.site.language),
    ...
    func makeItemHTML(for item: Item<Lazzaro>,
                      context: PublishingContext<Lazzaro>) throws -> HTML {
        HTML(
            .lang(context.site.language),
